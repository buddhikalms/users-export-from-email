...
export const metadata: Metadata = {
  title: "About - Email Exporter",
  description: "Learn about Email Exporter's mission to unlock valuable contacts hidden in business inboxes.",
};
    ...
    <main>
      <Section>
        <SectionIntro
          align="left"
          eyebrow="About"
          title="Email Exporter helps businesses unlock valuable contacts hidden in their inboxes."
        ...
        <div className="grid gap-6 lg:grid-cols-3">
          {[
            ["Contact discovery", "Outlook and IMAP folders often contain years of valuable conversations. Email Exporter turns that history into usable contact data."],
