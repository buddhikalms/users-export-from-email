...
export const metadata: Metadata = {
  title: "Terms of Service - ChatUp",
  description: "Professional placeholder terms of service for ChatUp.",
};
...
export default function TermsPage() {
  return (
    <main>
      <Section>
        <SectionIntro align="left" eyebrow="Legal" title="Terms of Service" description="Professional placeholder content for ChatUp product terms." />
        <div className="prose prose-slate max-w-none rounded-2xl border border-slate-200 bg-white p-8 dark:prose-invert dark:border-white/10 dark:bg-white/[0.04]">
          ...
          <p>ChatUp is provided to help users extract, clean, export, and sync contact data from mailboxes and connected platforms they are authorized to access.</p>
