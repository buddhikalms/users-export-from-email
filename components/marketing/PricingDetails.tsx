    ...
    <div className="space-y-24">
      <section>
        <div className="mb-8 max-w-2xl">
          <p className="text-sm font-bold uppercase tracking-[0.18em] text-blue-600 dark:text-blue-300">Compare plans</p>
          ...
          <table className="w-full min-w-[760px] text-left text-sm">
            ...
            <tbody className="divide-y divide-slate-100 dark:divide-white/[0.07]">
              {comparison.map(([feature, ...values]) => (
                <tr key={feature} className="transition-colors hover:bg-blue-50/40 dark:hover:bg-blue-400/[0.04]">
      ...
      <section>
        <div className="mb-8 max-w-2xl">
          <p className="text-sm font-bold uppercase tracking-[0.18em] text-blue-600 dark:text-blue-300">Optional extras</p>
          <h2 className="mt-3 text-3xl font-bold tracking-tight text-slate-950 dark:text-white sm:text-4xl">Available add-ons</h2>
          <p className="mt-3 leading-7 text-slate-600 dark:text-slate-300">Add only the capacity and integrations your workflow needs.</p>
        </div>
        <div className="grid items-start gap-5 lg:grid-cols-3">
          {addOnGroups.map(({ title, icon: Icon, items }) => (
            <article key={title} className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm dark:border-white/10 dark:bg-white/[0.03]">
              <div className="flex h-11 w-11 items-center justify-center rounded-2xl bg-blue-50 text-blue-600 dark:bg-blue-400/10 dark:text-blue-300"><Icon className="h-5 w-5" /></div>
      ...
      <section className="grid gap-8 lg:grid-cols-[0.85fr_1.15fr]">
        <div>
          <p className="text-sm font-bold uppercase tracking-[0.18em] text-blue-600 dark:text-blue-300">Expert help</p>
          ...
          <CircleDollarSign className="mt-8 h-10 w-10 text-blue-600 dark:text-blue-300" />
        </div>
