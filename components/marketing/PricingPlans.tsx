...
const plans: Plan[] = [
  {
    ...
    features: [
      ...
      { icon: SearchCheck, title: "Smart contact discovery", description: "Find useful contacts hidden inside conversations.", group: "Workflow" },
  ...
  },
  {
    ...
    features: [
      ...
      { icon: SlidersHorizontal, title: "Advanced contact filtering", description: "Narrow exports using more precise contact filters.", group: "Workflow" },
  ...
  },
  {
    ...
    features: [
      ...
      { icon: SearchCheck, title: "Advanced contact search", description: "Find the right people quickly across discovered contacts.", group: "Workflow" },
  ...
  },
  {
    ...
    features: [
      ...
      { icon: Building2, title: "White-label solution", description: "Present the platform under your own brand.", group: "Workflow" },
