    ...
    return nodes.map((node) => {
      ...
      return (
        <div key={node.id} className="space-y-2">
          <div
            className="flex items-start gap-3 rounded-2xl border border-border/70 bg-card/80 p-3 text-card-foreground shadow-sm transition hover:border-primary/40 dark:bg-card/75"
  ...
  return (
    <Card>
      ...
      <CardContent className="space-y-5">
        ...
        <div className="grid gap-4 soft-panel p-4 md:grid-cols-[1fr_1fr_auto] md:items-end">
