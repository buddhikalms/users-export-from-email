      ...
      <CardContent className="space-y-5">
        ...
        {showModal ? (
          <div className="fixed inset-0 z-50 flex items-center justify-center bg-foreground/30 px-4 backdrop-blur-sm">
            <div className="max-h-[82vh] w-full max-w-3xl overflow-hidden rounded-3xl border border-border bg-card/95 text-card-foreground shadow-xl backdrop-blur dark:bg-card">
              ...
              <div className="space-y-5 overflow-y-auto p-5">
                ...
                {summary ? (
                  <>
                    <div className="soft-panel rounded-2xl p-4 text-sm">
